...
implementation = Image.open(root / "design/qa/14-desktop-hifas-gateway-after-redesign-1600x1000.png").convert("RGB")
...
comparison.save(root / "design/qa/reference-vs-redesign.png", quality=94)
